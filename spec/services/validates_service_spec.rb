  ...
  describe ".valid1" do
    ...
    context "validation1" do
      ...
      it "valid1を行うとき判定がtrueであること" do
        expect(service.valid1).to eql true
      end
    end
    context "validation1" do
      ...
      it "valid1を行うとき判定がfalseであること" do
        expect(service.valid1).to eql false
      end
    end
  end
  # ５つある前提で文字と数字が異なると失敗
  describe ".valid2" do
    context "validation2" do
      ...
      it "valid2を行うとき判定がtrueであること" do
        expect(service.valid2).to eql true
      end
    end
    context "validation2" do
      service = JudgeService.new('A1 A2 A3 A4 A5')
      ...
      it "valid2を行うとき判定がfalseであること" do
        expect(service.valid2).to eql false
      end
    end
  end
  describe ".valid3" do
    ...
    context "validation3" do
      ...
      it "valid3を行うとき判定がtrueであること" do
        expect(service.valid3).to eql true
      end
    end
    context "validation3" do
      ...
      it "valid3を行うとき判定がfalseであること" do
        expect(service.valid3).to eql false
      end
    end
  end
